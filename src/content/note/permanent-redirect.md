...
description: "Запись о том, почему я отказался от отдельного домена в пользу субдоменов для новых проектов. Делись рабочим решением по настройке постоянного редиректа для сохранения SEO."
---
